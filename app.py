...
if st.button("Predict type of obesity"):
    ...
    if result=='Overweight_Level_I':
        st.success(f'The obesity type i{result}')
        #st.write(f'The obesity type i{result}')
        st.write(f"<span style='color:red'>'BMI between 25.0 and 29.9 ,Increased risk for health problems such as high blood pressure, high cholesterol, heart disease, stroke, type 2 diabetes, sleep apnea, and certain cancers.'</span>")
        st.write(f"<span style='color:red'>'Aim to achieve a modest weight loss of 5-10% of your body weight through a combination of a healthy diet and increased physical activity. Adopting healthy habits such as regular exercise, reducing calorie intake, avoiding processed and high-fat foods, and increasing intake of fruits, vegetables, and whole grains can help reduce the risk of health problems associated with excess weight.'</span>")
    if result=='Overweight_Level_II':
        st.success(f'The obesity type i{result}')
        #st.write(f'The obesity type i{result}')
        st.write(f"<span style='color:red'>'BMI between 30.0 and 34.9, Increased risk for the same health problems as those in Overweight Level I, but at a higher risk due to the increased amount of excess body fat.'</span>")
        st.write(f"<span style='color:red'>'Similar to Overweight Level I, aim to achieve a modest weight loss of 5-10% of your body weight through a combination of healthy eating and regular physical activity. Consulting with a healthcare professional or registered dietitian can help you develop a personalized weight loss plan and provide guidance and support along the way.'</span>")
    if result=='Obesity_Type_I':
        st.success(f'The obesity type i{result}')
        #st.write(f'The obesity type i{result}')
        st.write(f"<span style='color:red'>'BMI between 35.0 and 39.9 ,Increased risk for the same health problems as those in Overweight Level II, as well as other health problems such as gallbladder disease, osteoarthritis, and infertility.'</span>")
        st.write(f"<span style='color:red'>'A weight loss of 5-10% of your body weight can provide significant health benefits. However, for individuals with severe obesity, a greater amount of weight loss may be needed to improve health. Consultation with a healthcare professional or registered dietitian can help develop a personalized weight loss plan that includes a combination of a healthy diet, physical activity, and potentially other interventions such as medication or bariatric surgery.'</span>")
    if result=='Obesity_Type_II':
        st.success(f'The obesity type i{result}')
        #st.write(f'The obesity type i{result}')
        st.write(f"<span style='color:red'>'BMI between 40.0 and 44.9, Increased risk for the same health problems as those in Obesity Type I, but at a higher risk due to the increased amount of excess body fat.'</span>")
        st.write(f"<span style='color:red'>'A weight loss of 5-10% of your body weight can provide significant health benefits. However, for individuals with severe obesity, a greater amount of weight loss may be needed to improve health. Consultation with a healthcare professional or registered dietitian can help develop a personalized weight loss plan that includes a combination of a healthy diet, physical activity, and potentially other interventions such as medication or bariatric surgery.'</span>")
    if result=='Obesity_Type_III':
        st.success(f'The obesity type i{result}')
        #st.write(f'The obesity type i{result}')
        st.write(f"<span style='color:red'>'BMI 45 or above, Increased risk for the same health problems as those in Obesity Type II, but at a higher risk due to the significantly higher amount of excess body fat.'</span>")
        st.write(f"<span style='color:red'>'A weight loss of 5-10% of your body weight can provide significant health benefits. However, for individuals with severe obesity, a greater amount of weight loss may be needed to improve health. Consultation with a healthcare professional or registered dietitian can help develop a personalized weight loss plan that includes a combination of a healthy diet, physical activity, and potentially other interventions such as medication or bariatric surgery.'</span>")
    if result=='Insufficient_Weight':
        st.success(f'The obesity type i{result}')
        #st.write(f'The obesity type i{result}')
        st.write(f"<span style='color:red'>'BMI below 18.5,  Increased risk for malnutrition, weakened immune system, anemia, osteoporosis, and other health problems related to being underweight.'</span>")
        st.write(f"<span style='color:red'>'It is important to consult with a healthcare professional or registered dietitian to determine the underlying cause of insufficient weight and develop a personalized plan to achieve a healthy weight. This may include increasing calorie and nutrient intake through a balanced diet, incorporating strength training to build muscle mass, and addressing any underlying medical conditions.'</span>")
